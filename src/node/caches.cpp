...
CacheSizes CalculateCacheSizes(const ArgsManager& args, size_t n_indexes)
{
    ...
    // - txospenderindex (2%): serves gettxspendingprevout RPCs with very
    ...
    index_sizes.txospender_index = std::min(total_cache * 2 / 100, args.GetBoolArg("-txospenderindex", DEFAULT_TXOSPENDERINDEX) ? MAX_TXOSPENDER_INDEX_CACHE : 0);
    if (n_indexes > 0) {
